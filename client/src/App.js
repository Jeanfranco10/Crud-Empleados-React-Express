...
function App() {
  ...
  const add=()=>{
    Axios.post("http://localhost:3001/create",{
      ...
      Swal.fire({
          icon: "error",
           title: "Oops...",
          text: "Nose logró eliminar el empleado!!",
  ...
  const limpiarCampos=()=>{
     ...
     setPais("");
     setId("");
     //para q me pueda mostrar el boton agregar
     setEditar(false);
  }
...
<div className="input-group mb-3">
  ...
  className="form-control" placeholder="Ingrese el año de experiencia" aria-label="Username" aria-describedby="basic-addon1"/>
</div>
  </div>
